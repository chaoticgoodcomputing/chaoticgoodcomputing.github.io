...
- During C# related work — I have previously used [Wrapt](https://wrapt.dev/) as a [[tags/engineering/csharp]] web API scaffolding tool, which [describes its default options as opinionated](https://wrapt.dev/docs/customizing-wrapt-projects#smart-defaults)
...
- During [[tags/games/roblox]]-related CGC work: [“Flamework is a highly opinionated game framework”](https://www.npmjs.com/package/@flamework/core)
...
- Stumbling on the [black](https://github.com/psf/black) python formatter while wrangling [[tags/engineering/python|Python/Databricks]] codebases at M Science
